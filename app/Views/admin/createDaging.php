...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Tambah Daging</h1>

    <div class="row">
        <div class="col-8">
            <h2 class="my-3">Form Tambah Data Daging</h2>
            <form action="/Daging/save" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
