...
<div class="container-fluid">
    <?php if ($alamat) { ?>
        <?php foreach ($alamat as $s) : ?>
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800">Membeli Daging</h1>
            <div class="row">
                <div class="col-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <p class="form-control" id="type" name="type"><?= $daging['type']; ?></p>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="type" class="col-sm-2 col-form-label">Nama</label>
                        <div class="col-sm-10">
                            <p class="form-control" id="nama" name="nama"><?= $daging['nama']; ?></p>
                        </div>
                    </div>
                    <div class="row">
                        <label for="harga" class="col-sm-2 col-form-label">Harga</label>
                        <div class="col-sm-10">
                            <p class="form-control" id="harga" name="harga"><?= $daging['harga']; ?></p>
                        </div>
                    </div>
                    <div class="row">
                        <label for="tgldatang" class="col-sm-2 col-form-label">Tgldatang</label>
                        <div class="col-sm-10">
                            <p type="text" class="form-control" id="tgldatang" name="tgldatang"><?= $daging['tgldatang']; ?></p>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <form action="/Beli/save/<?= $daging['id']; ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="type" value="<?= $daging['type']; ?>">
                        <input type="hidden" name="item" value="<?= $daging['nama']; ?>">
                        <input type="hidden" name="harga" value="<?= $daging['harga']; ?>">
                        <input type="hidden" name="tgldatang" value="<?= $daging['tgldatang']; ?>">
